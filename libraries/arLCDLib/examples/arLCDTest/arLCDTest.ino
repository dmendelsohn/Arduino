...
void showMainScreen( void ) {
  ...
  lcd.printString("ar\\[4mL\\[9mC\\[12mD\\[3m Hardware Test V1.0");
//  lcd.color(RED);
//  lcd.printString("L");
//  lcd.color(GREEN);
//  lcd.printString("C");
...
//           A    B    C  D  E  F   G   H    I  J  K
  ...
  lcd.button( 3, x1Pos, yPos+190, width, height, option, alignment, radius, 2, 3 );
  lcd.button( 4, x2Pos, yPos+190, width, height, option, alignment, radius, 2, 4 );
  lcd.slider( 5, 20, 100, 280, 30, 5, 100, 5, 50, 0 );
