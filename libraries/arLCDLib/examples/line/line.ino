...
{  
  ...
  lcd.font(1);
  lcd.printString("\\[5x\\[175yLine Type 0");
  lcd.lineType(0);
  lcd.xy(80,183);
  lcd.line(300,183);
  lcd.printString("\\[5x\\[185yLine Type 1");
  lcd.lineType(1);
  lcd.xy(80,193);
  lcd.line(300,193);

  lcd.printString("\\[5x\\[195yLine Type 2");
  lcd.lineType(2);
  lcd.xy(80,203);
  lcd.line(300,203);

  lcd.printString("\\[5x\\[205yLine Type 3");  
  lcd.lineType(3);
  lcd.xy(80,213);
  lcd.line(300,213);

  lcd.printString("\\[5x\\[215yLine Type 4");  
  lcd.lineType(4);
  lcd.xy(80,223);
  lcd.line(300,223);
  lcd.xy(0,0);
